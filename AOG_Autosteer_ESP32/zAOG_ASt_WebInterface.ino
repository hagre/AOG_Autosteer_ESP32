...
void make_HTML01() {
	...
	strcat(HTML_String, "ver 4.3  -  10. Mai 2020 with OTA firmware update<br><br><hr>");
	...
	strcat(HTML_String, "<tr>");
	strcat(HTML_String, "<td>AOG 2019 and before</td><td><input type = \"radio\" onclick=\"sendVal('/?DataTransfVia=0')\" name=\"DataTransfVia\" id=\"JZ\" value=\"0\"");
	...
	strcat(HTML_String, "<tr>");
	strcat(HTML_String, "<td>AOG V4</td><td><input type = \"radio\" onclick=\"sendVal('/?DataTransfVia=4')\" name=\"DataTransfVia\" id=\"JZ\" value=\"4\"");
